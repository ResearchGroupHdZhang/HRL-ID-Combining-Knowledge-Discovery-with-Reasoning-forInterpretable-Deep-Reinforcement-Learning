...
agent_exploration_steps[0] = 20000
agent_exploration_steps[1] = 80000
# agent_exploration_steps[2] = 60000#修改
...
save_learned = [False for _ in range(3)] #修改
...
if args.mode == 'train':
    ...
    with tqdm.tqdm(total=args.episode_limit, desc='Train', **tqdm_config) as t:
        ...
        while episodeCount <= t.total:
            ...
            # anneal subgoal eps
            for goal in goal_to_train:
                agent_list[goal].anneal_eps(option_t[goal], option_learned[goal], option_performance[goal])
