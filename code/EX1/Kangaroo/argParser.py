...
parser.add_argument("--model", type=str, default='hrlid', help='hdqn | mlp | hrlid')
parser.add_argument("--num_process", type=int, default=8)
parser.add_argument("--meta_train_times", type=int, default=5)
parser.add_argument("--controller_train_times", type=int, default=150)

parser.add_argument("--mode", type=str, default='train', help='train | test')

# params for the game 'Montezuma'
# parser.add_argument("--game", default="montezuma_revenge.bin")
parser.add_argument("--game", default="Kangaroo.bin")
# parser.add_argument("--game", default="KangarooCX2689.bin")
# parser.add_argument("--game", default="KangarooPAL.bin")
...
parser.add_argument("--explorationSteps", type=int, default=250000)
...
parser.add_argument("--arity_num", type=int, default=5)
...
# params for log
parser.add_argument("--logdir", type=str, default='./logdir/E1/')
