...
def initialize_ale_env(rom_file, args):
    ...
    #     for j in range(50):
    #         ale.act(act)
    #         ale.saveScreenPNG('/root/rlid-master/Game/image/'+str(act)+'-'+str(j)+'.png')
    ...
    def goalReached(self, img, loc, coords=None):
        ...
        if loc == 'HighLadder':
            if man_x >= 130 and man_x <= 143 and man_y >= 32 and man_y <= 75:
                return True
        if loc == 'Collection1':
            if man_x >= 118 and man_x <= 126 and man_y >= 107 and man_y <= 120:
                return True
        if loc == 'Collection3':
    ...
    def goalReached_(self, img, loc, coords=None):
        ...
        if loc == 'HighLadder':
            if man_x >= 130 and man_x <= 143 and man_y >= 32 and man_y <= 75:
                return True
        if loc == 'Collection1':
            if man_x >= 113 and man_x <= 132 and man_y >= 100 and man_y <= 124:
                return True
        if loc == 'Collection3':
            if man_x >= 54 and man_x <= 69 and man_y >= 55 and man_y <= 75:
                return True
